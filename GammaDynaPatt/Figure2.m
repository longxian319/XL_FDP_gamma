...
load([pwd,'/Pre-processed data/v4_00.6SmRes8_2.5SD_ma027_032_Band30HzOctober01_23:56.mat'])
...
subplot(2,4,1)
flagType = 1 ;
movie_burst_2(sigSmooth,WCentroids,patternIdx,rangeFrame,flagType)
subplot(2,4,2)
flagType = 2 ;
movie_burst_2(sigSmooth,WCentroids,patternIdx,rangeFrame,flagType)
subplot(2,4,3)
% load the burst statistics (2 times resize)
load([pwd,'/Pre-processed data/v4_00.6Sm_2.5SD_ma027_032_Band30HzSeptember23_11:07.mat'])
